...
export class Pair {
  ...
  public static getAddress(factory: Factory, tokenA: Token, tokenB: Token): string {
  ...
  public constructor(factory: Factory, tokenAmountA: TokenAmount, tokenAmountB: TokenAmount) {
    const tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
      ? [tokenAmountA, tokenAmountB]
      : [tokenAmountB, tokenAmountA]
    this.liquidityToken = new Token(
      tokenAmounts[0].token.chainId,
      Pair.getAddress(factory, tokenAmounts[0].token, tokenAmounts[1].token),
      18,
      'Neko-LPs',
      'Neko-LP'
    )
  ...
  public getOutputAmount(inputAmount: TokenAmount): [TokenAmount, Pair] {
    ...
    return [outputAmount, new Pair(this.factory, inputReserve.add(inputAmount), outputReserve.subtract(outputAmount))]
  }
  ...
  public getInputAmount(outputAmount: TokenAmount): [TokenAmount, Pair] {
    ...
    return [inputAmount, new Pair(this.factory, inputReserve.add(inputAmount), outputReserve.subtract(outputAmount))]
  }
